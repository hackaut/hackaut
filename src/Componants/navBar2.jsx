...
const NavBar2 = (props) => {
  return (
    <header className="flex flex-wrap md:justify-start sm:flex-nowrap z-50 w-full bg-blue-200 text-sm py-4 border-b-2 border-blue-700 z-100 sticky top-0  ">
      <nav className="max-w-[85rem] w-full mx-auto px-4 md:flex md:items-center md:justify-between">
        <NavLink to="/" className="flex-none text-xl font-black" style={{display: 'flex', gap: '10px'}}>
          <img
            className="logonav"
